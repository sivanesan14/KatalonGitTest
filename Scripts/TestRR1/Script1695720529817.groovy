...
WebUI.verifyElementPresent(findTestObject('Page_OrangeHRM/span_Admin'), 0)

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/i_Admin_oxd-icon bi-chevron-left'))
